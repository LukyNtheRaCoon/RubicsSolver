...
# Force pure Python implementation to avoid CFFI/Binary issues on robot
# warnings.warn("Forcing pure-Python implementation for robot compatibility.", SlowContextWarning)
...
def _solve(cube, pattern, max_depth=24):
    ...
    # search.Search().solution(cube, max_depth, time_out, verbose)
...
def solve(cubestring, patternstring=None, max_depth=24):
    """
    Solve a Rubik's cube using two-phase algorithm (Pure Python Version).
    """
