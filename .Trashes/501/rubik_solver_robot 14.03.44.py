...
# Import the local simple solver
try:
    import simple_solver as solver
    HAS_SOLVER = True
    print("Local simple solver loaded successfully.")
except ImportError as e:
    HAS_SOLVER = False
    print(f"Warning: Local solver not found. Error: {e}")
...
class RubikSolverRobot:
    ...
    def run(self):
        try:
            ...
            print("\n--- Step 2: Solving ---")
            if HAS_SOLVER:
                solution = solver.solve(test_scramble_state)
